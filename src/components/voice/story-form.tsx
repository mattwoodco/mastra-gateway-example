        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
            ...
            <input
              ...
              onChange={(e) =>
                handleChange("protagonistDetails.name", e.target.value)
              }
              className="mt-1 block w-full rounded-md border border-gray-300 px-4 py-2.5 bg-white dark:bg-gray-900 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
            />
          </label>
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
            ...
            <input
              ...
              onChange={(e) =>
                handleChange("protagonistDetails.gender", e.target.value)
              }
              className="mt-1 block w-full rounded-md border border-gray-300 px-4 py-2.5 bg-white dark:bg-gray-900 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
            />
          </label>
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
            ...
            <input
              ...
              onChange={(e) =>
                handleChange("protagonistDetails.occupation", e.target.value)
              }
              className="mt-1 block w-full rounded-md border border-gray-300 px-4 py-2.5 bg-white dark:bg-gray-900 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
            />
          </label>

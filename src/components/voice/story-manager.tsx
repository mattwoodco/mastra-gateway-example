          ...
          <div className="space-y-6">
            <div className="prose dark:prose-invert max-w-none">
              <div className="space-y-4">
                {(storyState.phase === "beginning" ||
                  storyState.phase === "middle" ||
                  storyState.phase === "end") && (
                  <div className="space-y-4">
                    <p className="text-lg">
                      {
                        formatContent(
                          storyState.content[storyState.phase] || "",
                        ).story
                      }
                    </p>
                    {formatContent(storyState.content[storyState.phase] || "")
                      .choices && (
          ...
          <div className="space-y-6">
            <div className="prose dark:prose-invert max-w-none">
              <div className="space-y-4">
                <div className="space-y-4">
                  <p className="text-lg">
                    {formatContent(storyState.content.end || "").story}
                  </p>
                </div>
              </div>
            </div>
